...
@home_route.route("/api/questions", methods=["GET"])
def get_questions():
...
@home_route.route("/api/questions/<int:question_id>/answer", methods=["POST"])
...
@home_route.route("/api/courses", methods=["GET", "POST"])
def manage_courses():
...
@home_route.route("/api/courses/<int:course_id>", methods=["GET"])
...
@home_route.route("/api/courses/<int:course_id>", methods=["PUT", "DELETE"])
...
@home_route.route("/api/search", methods=["GET"])
def search_content():
...
@home_route.route("/api/users/me", methods=["GET"])
...
@home_route.route("/question/delete/<int:question_id>", methods=["DELETE"])
...
@home_route.route("/question/update/<int:question_id>", methods=["PUT"])
...
@home_route.route("/api/users/me", methods=["PUT"])
...
@home_route.route("/api/auth/google", methods=["POST"])
def google_login():
...
@home_route.route("/api/auth/logout", methods=["POST"])
def logout():
