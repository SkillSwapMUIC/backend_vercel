...
def autocomplete():
    ...
    for question in questions:
        question_link = url_for('qanda.get_question', question_id=question.id, _external=True)
        json_list.append({"title": question.title, "id": question.id, "link": question_link})
